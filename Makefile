...
# trustyai.opendatahub.io/trustyai-service-operator-bundle:$VERSION and trustyai.opendatahub.io/trustyai-service-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= trustyai.opendatahub.io/trustyai-service-operator
